...
#Добавление цикла для проверки на самый дорогой материал        
for material, info in warehouse.items():
...
#Вывод результатов и добавление цикла для проверки на критический остаток
print("=" * 75)
...
#Моделирование выдачи материала
