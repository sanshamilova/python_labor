...
#Импорт данных из CSV файла и преобразование столбца времени в нужный формат
df_1 = pd.read_csv("5 train.csv")
df_1["datetime"] = pd.to_datetime(df_1["datetime"])

#Поиск конкретного часа в сутках с максимальным числом поездок в выходные дни
...
#Построение столбчатой диаграммы с средним числом поездок по сезонам
...
#Фильтр по числу поездок > 500
#Нахождение сезона, в котором чаще всего
...
#Сохранение в CSV таблицу среднюю температуру и среднее число поездок по месяцам
